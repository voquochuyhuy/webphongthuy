...
import img_title from "../phongthuy-web/TrangChu/banner_desktop.jpg";

import routes from "../phongthuy-web/routes";
import routes_hide from "../phongthuy-web/routes_hide.js";
          ...
          {this.getRoute() ? (
            <div className={classes.content} style={{marginTop:"0"}}>
              <div className={classes.container}>
                <Switch>{this.getRoutes(routes_hide)}</Switch>
              </div>
            </div>
          ) : (
