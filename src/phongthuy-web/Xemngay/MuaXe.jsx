...
import Muaxe from "../../views/Tables/Muaxe";
...
class Kethon extends React.Component {
  ...
  clicked = () => {
    ...
    if (this.state.value === false)
      ...
      <p style={{ fontSize: "14px", color: "red", marginLeft: "3%", fontWeight: "bold" }}> Ngày 1/7/2019 là ngày Không xấu nhưng cũng chưa tốt cho việc Mua xe.</p>
