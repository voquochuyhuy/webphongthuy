...
import MuaNhanData from "../../views/Tables/MuaNhaData";
  ...
  clicked = () => {
    if (this.state.value === false)
      return (<div>
        ...
        <p style={{ fontSize: "14px", color: "brown", marginLeft: "3%", fontWeight: "bold" }}>Ngày 1/7/2019 là ngày Tốt cho việc Mua nhà, mua đất.</p>
        <br />       
