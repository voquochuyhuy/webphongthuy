...
import TotXauData from "../../views/Tables/TotXauData";
...
class Totxau extends React.Component {
  ...
  clicked = () => {
    if (this.state.value === false)
      ...
      <p style={{ fontSize: "14px", color: "red", marginLeft: "3%", fontWeight: "bold" }}> Ngày 1/7/2019 là ngày Không xấu nhưng cũng chưa tốt.</p>
  ...
  render() {
    ...
    return (
      <div style={{ marginTop: "0" }}>
        ...
        {/* {this.state.value === false ?(<img src={batquai} style={{width:"50%",marginLeft:"25%"}}></img>):<div/>} */}
      </div>
