...
<p style={{textAlign:"center",fontSize:"25px",color:"brown"}}>#6 Tiêu chí xem tuổi VỢ CHỒNG 2019 tốt hay xấu để Hóa Giải Xung Khắc </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Từ trước đến nay, ông bà ta đều quan niệm 
      ...
      <p style = {{fontSize:"16px",color:"red",marginLeft:"3%",fontWeight:"bold"}}> #6 yếu tố quan trọng để xem tuổi vợ chồng 2019, 2020 
      </p>
      <p  style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>
      ...
      <p style = {{fontSize:"16px",color:"red",marginLeft:"3%",fontWeight:"bold"}}>
      ...
      <p style = {{fontSize:"16px",color:"red",marginLeft:"3%",fontWeight:"bold"}}>Xem tuổi vợ chồng theo cung phi bát tự</p> 
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Khi xem tuổi vợ chồng con cái có hợp 
     ...
     <p style = {{fontSize:"16px",color:"red",marginLeft:"3%",fontWeight:"bold"}}>
      ...
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Mệnh chồng 1994	Dương Hỏa </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Mệnh vợ 1995	Dương Hỏa </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Kết Luận: Bình Hòa (1 Điểm) </p>
      <p style = {{fontSize:"16px",color:"red",marginLeft:"3%",fontWeight:"bold"}}>Xét về Thập nhị địa chi </p> 
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Địa chi chồng 1994	Tuất </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Địa chi vợ 1995	Hợi </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}} > Kết Luận: Bình Hòa (1 Điểm) </p>
      <p style = {{fontSize:"16px",color:"red",marginLeft:"3%",fontWeight:"bold"}}>Xét về   Can chi     </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Can chi chồng 1994	Giáp </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Can chi vợ 1995	Ất </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Kết Luận: Bình Hòa (1 Điểm) </p>
      <p style = {{fontSize:"16px",color:"red",marginLeft:"3%",fontWeight:"bold"}}>Xét về Cung phi bát tự chồng Giáp Tuất vợ Ất Hợi Cung phi chồng 1994	Càn Cung phi vợ 1995	</p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Khảm Kết Luận: Lục Sát (0 Điểm) </p>
      <p style = {{fontSize:"16px",color:"red",marginLeft:"3%",fontWeight:"bold"}}>Xét về Niên mệnh</p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Niên mệnh năm sinh chồng 1994	Kim </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Niên mệnh năm sinh vợ 1995	Thủy </p>
      <p style = {{fontSize:"16px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>Kết Luận: Tương Sinh (2 Điểm) </p>
      <p style = {{fontSize:"16px",color:"red",marginLeft:"3%",fontWeight:"bold"}}> Tổng điểm : 5 Điểm trung bình, cố gắng vun đắp tình cảm nhé bạn !</p>
      <br />
