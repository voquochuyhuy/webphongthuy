  ...
  clicked = ()=>{
    ...
    return (<div>
     ...
     <p style = {{fontSize:"20px",color:"red",marginLeft:"3%",fontWeight:"bold"}}>Bình giải tốt xấu xem tuổi làm nhà cho người sinh năm 1980 </p>
      <p style = {{fontSize:"14px",color:"brown",marginLeft:"3%",fontWeight:"bold"}}>- Trước khi làm nhà, động thổ, cải tạo, xây cất sửa sang nhà cửa thì gia chủ tuổi Canh Thân (1980) phải xem mình có phạm tuổi đại kỵ không (Tam Tai, Hoang Ốc, Kim Lâu). </p>
