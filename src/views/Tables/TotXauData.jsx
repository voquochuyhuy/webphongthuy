      ...
      <GridItem xs={12}>
        <Card>
          <CardHeader color="rose" icon>
            ...
            <h4 className={classes.cardIconTitle}>Những ngày tốt trong tháng 7 năm 2019</h4>
          </CardHeader>
          <CardBody>
            <Table
       ...
       <GridItem xs={12}>
        <Card>
          <CardHeader color="rose" icon>
            ...
            <h4 className={classes.cardIconTitle}>Những ngày xấu trong tháng 7 năm 2019</h4>
          </CardHeader>
          <CardBody>
            <Table
              tableHeaderColor="primary"
